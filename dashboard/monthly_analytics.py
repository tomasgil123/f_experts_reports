...
def sales_performance_metrics(df, selected_month, selected_year, selected_month_string):
    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <div style="display: {'block' if display_previous_year != '0.00%' else 'none'}" >vs same month last year: <span style="color: {'green' if card_data[6]['trend'] == 'up' else 'red'}" >{card_data[6]["value"]}</span></div>
            </div>
        </div>
        </div>
        <div class="col">
...
def customer_acquisition_metrics(df, selected_month, selected_year, selected_month_string):
    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <div style="display: {'block' if display_previous_year != '0.00%' else 'none'}" >vs same month last year: <span style="color: {'green' if card_data[4]['trend'] == 'up' else 'red'}" >{card_data[4]["value"]}</span></div>
            </div>
        </div>
        </div>
        <div class="col">
...
def get_marketing_campaign_sales(df, selected_month, selected_year):
    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <div style="display: {'block' if display_previous_year_open != '0.00%' else 'none'}" >vs same month last year: <span style="color: {'green' if card_data[4]['trend'] == 'up' else 'red'}" >{card_data[4]["value"]}</span></div>
            </div>
        </div>
        </div>
        <div class="col">
