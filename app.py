...
inactive_clients = ['tenzo_tea', 'free_planet', 'the_perfect_jeans', 'couleur_nature', 'caravan', 'bon_artis', 'lothantique', 'boredwalk', 'born_to_rally', 'glimmer_wish', 'little_hometown', "trek_light", "true_classic", "jack_archer", "grab2art", "future_kind", "cheese_brothers", "be_huppy", "dolan_geiman"]
